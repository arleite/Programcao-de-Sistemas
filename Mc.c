            ...
            case 3:
                ...
                if (opcao == 1)
                {
                    ...
                    if(opcao == 1)
                    {
                        ...
                        if (fileContadorFuncionario = fopen("Files/Ementas/PequenoAlmoco/ContadorPequenoAlmoco.txt" ,"r"))
                        {
                            fclose(fileContadorFuncionario);
                            printf("Boas");

                        }else {
                            fileContadorFuncionario = fopen("Files/Ementas/PequenoAlmoco/ContadorPequenoAlmoco.txt" ,"w");
                            fprintf(fileContadorFuncionario, "%d", contador);
                            fclose(fileContadorFuncionario);
                        }
                    ...
                    if(opcao == 2)
                    {
                        ...
                        if (fileContadorFuncionario = fopen("Files/Ementas/Almoco/ContadorAlmoco.txt" ,"r"))
                        {
                            fclose(fileContadorFuncionario);
                        }else {
                            fileContadorFuncionario = fopen("Files/Ementas/Almoco/ContadorAlmoco.txt" ,"w");
                            fprintf(fileContadorFuncionario, "%d", contador);
                            fclose(fileContadorFuncionario);
                        }
                    ...
                    if(opcao == 3)
                    {
                        mkdir("Files/Ementa/Lanche", 0777);

                        if (fileContadorFuncionario = fopen("Files/Ementas/Lanche/ContadorLanche.txt" ,"r"))
                        {
                            fclose(fileContadorFuncionario);
                            printf("Boas");

                        }else {
                            fileContadorFuncionario = fopen("Files/Ementas/Lanche/ContadorLanche.txt" ,"w");
                            fprintf(fileContadorFuncionario, "%d", contador);
                            fclose(fileContadorFuncionario);
                        }
                        ...
                        fileContadorPequenoAlmoco = fopen ("Files/Ementas/Lanche/ContadorLanche.txt", "w");
                        fprintf(fileContadorPequenoAlmoco, "%d", contador);
                        fclose(fileContadorPequenoAlmoco);
                    ...
                    if(opcao == 4)
                    {
                        mkdir("Files/Ementa/Jantar", 0777);
                    }
                    if(opcao == 5)
                    {
                       mkdir("Files/Ementa/Sobremesa", 0777);
                    }
                    if(opcao == 6)
                    {
                       mkdir("Files/Ementa/Bebida", 0777);
                    }
